...
-- ─── 19. DONNÉES INITIALES CMS (ÉTAPE A) ────────────────

-- Sujet de vote par défaut (CRITIQUE)
INSERT INTO sujets (titre, description, actif)
VALUES (
...
INSERT INTO configuration (cle, valeur, type) VALUES
  ...
  ('photo_cin_recto_actif',          'true',                                                                  'boolean'),
  ('photo_cin_recto_obligatoire',    'false',                                                                 'boolean'),
  ('photo_cin_verso_actif',          'true',                                                                  'boolean'),
  ('photo_cin_verso_obligatoire',    'false',                                                                 'boolean'),
  ('otp_sms_obligatoire',            'true',                                                                  'boolean'),
  ('ocr_cin_obligatoire',            'false',                                                                 'boolean'),
  ('gps_obligatoire',                'false',                                                                 'boolean'),
